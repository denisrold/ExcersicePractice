function maximumPerimeterTriangle1(sticks:number[]):number[] {
    // Write your code here
    let maxPerimeter = 0;
    let maxTriangle:number[] = [];
    let orderSticks:number[] = sticks.sort((a, b) => a - b);
  ...
  const sticks1 = [2, 1, 1, 1, 3, 2, 3];
  console.log(maximumPerimeterTriangle1(sticks1));
